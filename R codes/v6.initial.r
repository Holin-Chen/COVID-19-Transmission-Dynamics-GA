...
#pmgenpars <- c(0,3.158971,1.516190) # Andrew estimated from traced links
#pmgenpars <- c(0,1.233560,6.103171)
...
ltppars <- matrix(c(oldtheta,rep(0.5,length(oldtheta))),nrow=3)
